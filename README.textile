...
<pre>
    9> hm_cli:rstore("Domain1", "Tbl1", [{"Fld1", key1},{"Fld2", value1}]).
    {ok,4}
    10> hm_cli:rstore("Domain1", "Tbl1", [{"Fld1", key2},{"Fld2", value2}]).
    {ok,4}
    11> hm_cli:rstore("Domain1", "Tbl1", [{"Fld1", key3},{"Fld2", value3}]).
    {ok,4}
</pre>
...
<pre>
    12> hm_cli:rget("Domain1", "Tbl1", "Fld1 == key2").
...
<pre>
    13> hm_cli:create_table("Domain1", "Tbl2", [{"Fld1",true,true},{"Fld2",true,true},{"Fld3",false,nil}]).
...
<pre>
    15> hm_cli:rstore("Domain1", "Tbl2", [{"Fld1", xxx},{"Fld2", 32},{"Fld3", textfile1}]).
    {ok,5}
    16> hm_cli:rstore("Domain1", "Tbl2", [{"Fld1", yyy},{"Fld2", 150},{"Fld3", textfile1}]).
    {ok,5}
    17> hm_cli:rstore("Domain1", "Tbl2", [{"Fld1", zzz},{"Fld2", 3000},{"Fld3", textfile1}]).
    {ok,5}
</pre>
...
<pre>
    18> hm_cli:rget("Domain1", "Tbl2", "Fld1 == yyy or Fld2 == 32").
    {ok,[['Domain1Tbl2',xxx,32,textfile1],
         ['Domain1Tbl2',yyy,150,textfile1]]}
    19> hm_cli:rget("Domain1", "Tbl2", "Fld1 == yyy and Fld2 == 150").
