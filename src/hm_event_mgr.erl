...
%%% @doc event manager to add/delete event handlers
%%% @end
...
%%%===================================================================
log(Msg) ->
    gen_event:notify(?MODULE, {log, Msg}).
...
add_file_handler() ->
    gen_event:add_handler(?MODULE, hm_log_h_file, []).

delete_file_handler() ->
    gen_event:delete_handler(?MODULE, hm_log_h_file, []).
